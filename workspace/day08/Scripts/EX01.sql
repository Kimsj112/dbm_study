 ...
 * 가상 테이블이다.
 * 실제 데이터가 저장되는것은 아니지만 VIEW를 통해서 데이터를 관리할 수 있디.
 * 
...
SELECT P.*, ROUND((SYSDATE - BIRTH_DATE) / 365, 2) 
FROM PLAYER p ;
...
-- SELF JOIN
SELECT E.LAST_NAME || ' ' || E.FIRST_NAME 사원이름,
