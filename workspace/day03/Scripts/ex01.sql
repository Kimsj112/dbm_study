...
ALTER TABLE TBL_CAR ADD CONSTRAINT PK_TBL_CAR PRIMARY KEY(CAR_NUMBER)
/*
...
ALTER TABLE TBL_CAR DROP CONSTRAINT PK_TBL_CAR;
...
-- 칼럼 이름 수정(고유번호)
ALTER TABLE ANIMAL RENAME COLUMN ANIMAL_ID TO ID; 

-- 칼럼 삭제(먹이)
ALTER TABLE ANIMAL DROP COLUMN EAT;

-- 칼럼 수정(종류 칼럼의 자료형을 변경)
ALTER TABLE ANIMAL MODIFY (KIND CHAR(1000));
ALTER TABLE ANIMAL MODIFY (KIND VARCHAR2(1000));
